...
public class DbOutGenerator {

    private static Logger m_logger = LoggerFactory.getLogger(DbOutGenerator.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        gen.generate("datagen/configuration-dbout-testing.xml");
