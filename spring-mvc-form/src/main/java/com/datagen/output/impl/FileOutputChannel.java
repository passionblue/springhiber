...
public class FileOutputChannel extends  AbstractOutputChannel<String> {

    private static Logger m_logger = LoggerFactory.getLogger(FileOutputChannel.class);
    
    private String fileName;
    private PrintWriter writer;
    private int    dataCount;
    
    public FileOutputChannel(String id, int maxCount, String fileName, boolean includeHeader) {
        super(id, maxCount);
